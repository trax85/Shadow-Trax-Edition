...
echo 1799040 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq
...
echo 1804800 > /sys/devices/system/cpu/cpu4/cpufreq/scaling_min_freq
...
echo 9887 > /sys/class/devfreq/cpubw/min_freq
echo 9887 > /sys/class/devfreq/mincpubw/min_freq
echo 614400 > /sys/class/devfreq/qcom,cci.49/min_freq
#Walt-Toggles
