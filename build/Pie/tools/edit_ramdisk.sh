...
if [ $VOLT == 1 ]; then
	...
	echo "write /sys/devices/system/cpu/cpu0/cpufreq/UV_mV_table \"700 710 760 790 890 920 930 940 950 1030 1100 700 700 740 800 810 810 820 900 950 960\"" >> $CONFIGFILE
	echo "" >> $CONFIGFILE
elif [ $VOLT == 2 ]; then
