...
if [ $VOLT == 1 ]; then
	...
	echo "write /sys/devices/system/cpu/cpu0/cpufreq/UV_mV_table \"680 710 760 790 890 920 930 940 950 1020 1100 680 700 740 800 810 810 820 900 950 960\"" >> $CONFIGFILE
	echo "" >> $CONFIGFILE
elif [ $VOLT == 2 ]; then
	...
	echo "write /sys/devices/system/cpu/cpu0/cpufreq/UV_mV_table \"720 730 750 880 920 930 940 950 980 1050 1140 710 720 760 800 830 850 870 950 960 980\"" >> $CONFIGFILE
	echo "" >> $CONFIGFILE
fi
