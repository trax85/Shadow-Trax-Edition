...
if [ $VOLT == 1 ]; then
	...
	echo "write /sys/devices/system/cpu/cpu0/cpufreq/GPU_mV_table \"700 720 760 800 860 920 970 1020 1050\"" >> $CONFIGFILE
	echo "write /sys/devices/system/cpu/cpu0/cpufreq/UV_mV_table \"680 710 760 790 890 910 920 950 960 680 710 740 800 810 810 820 900 930 950\"" >> $CONFIGFILE
	echo "" >> $CONFIGFILE
elif [ $VOLT == 2 ]; then
