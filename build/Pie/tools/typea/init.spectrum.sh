...
if [[ $(getprop sys.boot_completed) -eq 1 ]]; then
	...
	write /sys/devices/system/cpu/cpu0/cpufreq/interactive/hispeed_freq 1632000
	write /sys/devices/system/cpu/cpu0/cpufreq/interactive/min_sample_time 20000
	write /sys/devices/system/cpu/cpu0/cpufreq/interactive/timer_rate 20000
	write /sys/devices/system/cpu/cpu0/cpufreq/interactive/boost 0
	write /sys/devices/system/cpu/cpu0/cpufreq/interactive/target_loads "80 960000:30 1017600:40 1190400:50 1305600:60 1401600:75 1632000:80"
	...
	echo interactive > /sys/devices/system/cpu/cpu0/cpufreq/scaling_governor
	echo 691200 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq
	echo 1799040 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq 
	write /sys/devices/system/cpu/cpu0/cpufreq/interactive/go_hispeed_load 75
	write /sys/devices/system/cpu/cpu0/cpufreq/interactive/above_hispeed_delay 25000
	write /sys/devices/system/cpu/cpu0/cpufreq/interactive/hispeed_freq 1799040
	write /sys/devices/system/cpu/cpu0/cpufreq/interactive/min_sample_time 20000
	write /sys/devices/system/cpu/cpu0/cpufreq/interactive/timer_rate 20000
	write /sys/devices/system/cpu/cpu0/cpufreq/interactive/boost 0
